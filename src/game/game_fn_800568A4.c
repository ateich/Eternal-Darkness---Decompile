...
extern s32 fn_800462C8(s32 value);
extern void fn_8012B344(void *);
extern u64 fn_802011D4(void *event);

s32 fn_800568A4(void *context, void *event, u32 *result)
{
    ...
    if (kind == 7) {
        fn_801A7778(fn_8004918C());
        if (fn_80035FB8(context, strings + 0xA0, strings + 0x114,
    ...
    if (kind == 41) {
        if (fn_800462C8(0) != 0x22) fn_8012B344(object);
        return 1;
    }
    if (kind == 42) {
        if (fn_800462C8(0) != 0x22) fn_8012B344(object);
