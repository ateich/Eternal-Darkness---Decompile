...
extern void fn_8017F87C(void*, void*, void*, void*);
extern void fn_8017ED50(void*, void*);
extern void fn_8018EDE4(void);
extern void fn_8018A88C(void);

void* fn_8017F7D8(void* first, void* second, void* config)
{
    void* result;

    result = fn_8018038C(lbl_8064D238, lbl_80606334);
    if (result != 0) {
        fn_8017F87C(result, first, second, config);
        fn_8017ED50(result, config);
