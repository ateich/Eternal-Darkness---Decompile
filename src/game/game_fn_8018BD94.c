...
extern void fn_80189968(void*, void*, void (*)(void*, float, float, float, float, float));
...
void fn_8018BD94(u8* object)
{
    ...
    color = color_data;
    {
        ...
        byte_offset = 0;
        for (; i < count; i++) {
            fn_80189968(object_data, vertex_data + byte_offset, fn_8018D020);
            {
                int j;
