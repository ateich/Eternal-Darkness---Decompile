...
void fn_80165A9C(Parser* parser, Entry* output)
{
    ...
    fn_801658D0(parser);
    fn_8015F1F8(state, fn_8015EAD0(state), start);
    fn_8015F1F8(state, value.extra, fn_8015EC10(state));
    fn_80163F38(parser, 0x106, 0x112, output);
