...
extern void fn_8018B3C8(void);
extern void fn_8018B580(void);
extern void fn_8019B4D4(void*, void*, void*, u8*);
extern void fn_8019B6F0(void*, u8*);
extern void fn_8019B73C(void);

void* fn_8019AF2C(void* first, void* second, u8* third)
{
    u8* result;
    ...
    if (result != 0) {
        ...
        *(void (**)(void))(result + 0x14C) = fn_8019B73C;
        if (*(s32*)(third + 0x24) != 0) {
            *(void (**)(void))(result + 0x148) = fn_8018B580;
        } else {
            *(void (**)(void))(result + 0x148) = fn_8018B3C8;
        }
        *(u16*)(result + 0x22) = 4;
    }
    return result;
