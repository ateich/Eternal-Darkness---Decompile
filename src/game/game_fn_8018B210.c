...
extern void fn_80189028(void*, void*, void (*)(void*, float, float, float, float, float));
...
void fn_8018B210(u8* object)
{
    ...
    color = color_data;
    fn_80189028(object_data, vertex_data, fn_8018D020);
    ...
    /* MWCC coalesces these dead pointer live ranges into retail's r28/r27 loop pair. */
