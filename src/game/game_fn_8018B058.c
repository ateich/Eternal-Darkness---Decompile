...
extern void fn_80188E28(void*, void*, void (*)(void*, float, float, float, float, float));
...
void fn_8018B058(u8* object)
{
    ...
    color = color_data;
    fn_80188E28(object_data, vertex_data, fn_8018D020);
