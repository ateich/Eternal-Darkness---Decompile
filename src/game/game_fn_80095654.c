...
typedef struct State80095654 {
    u8 pad00[0xCC];
    u32 value;
} State80095654;

typedef struct Event80095654 {
    u8 pad00[0x14];
    int value;
} Event80095654;

typedef struct Context80095654 {
    u8 pad00[0x68];
    void* object;
} Context80095654;

typedef struct Object80095654 {
    u8 pad00[0x30];
    short value;
} Object80095654;
...
extern FN_80201E78_RETURN fn_80201E78(FN_80201E78_PARAMETERS);extern Event80095654* fn_800935CC(int, void*, u32, int);
                ...
                register Context80095654* context)
{
    ...
    if (event == 0) {
        ...
        action = fn_801294DC(owner, 0xA5, 0x30, 6);
        if (action != 0) {
            int tag = index << 8;
