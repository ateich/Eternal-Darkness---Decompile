...
/* NonMatching: honest reconstruction of the effect placement and color update. */
    ...
    if (state != 0 && state->finished == 0) {
        ...
        if (owner == 0) {
            ...
            if (model != 0) {
                ...
                case 1: color[0] = 255; color[1] = 0; color[2] = 0; color[3] = 255; fn_801FD80C(arg, color); break;
                case 2: color[0] = 0; color[1] = 0; color[2] = 255; color[3] = 255; fn_801FD80C(arg, color); break;
                case 3: color[0] = 0; color[1] = 255; color[2] = 0; color[3] = 255; fn_801FD80C(arg, color); break;
                case 4: color[0] = 255; color[1] = 0; color[2] = 255; color[3] = 255; fn_801FD80C(arg, color); break;
                default: fn_801FD80C(arg, lbl_8064B590); break;
                }
            }
