...
extern void *fn_80201B54(); extern float fn_80200534(void *, int, int);
extern int fn_80117E58(void); extern float fn_80200BDC(void); extern Owner *fn_80201B8C();
...
unsigned short fn_800BB9A4(void *output, void *object)
{
    ...
    if (time > lbl_8064F010) { Source *source = fn_80201B8C(object)->source; result.first = source->first; result.second = source->second; result.byte = source->byte; }
