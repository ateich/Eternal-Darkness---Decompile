...
extern void fn_8007CD5C(void *context, void *event);

s32 fn_80056B88(void *context, void *event, u32 *result)
{
    ...
    if (kind == 6) {
        ...
        fn_8020123C(204, fn_80201B44(), fn_80201B44(), 0);
        return 1;
    }
    if (kind == 7) {
        fn_801A7778(fn_8004918C());
        if (fn_80035FB8(context, strings + 0xA0, strings + 0x120,
