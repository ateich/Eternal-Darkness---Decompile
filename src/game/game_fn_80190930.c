...
extern u32 lbl_80651D90;
extern u16 lbl_80651D94;
...
void fn_80190930(u8* data, void* arg1, void* arg2, u8* config)
{
    LocalData local;
    u32 value;
    u8* object;
    ...
    local.word = lbl_80651D90;
    local.half = lbl_80651D94;
    object = *(u8**)(data + 0x4C);
    ...
    *(u32*)(data + 0x44) = 0;
    ...
    fn_8018E230(object, object + 0x2B, 1, 0, (signed char)config[0x16], config[0x17]);
