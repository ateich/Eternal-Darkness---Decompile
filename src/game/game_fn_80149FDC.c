...
extern void fn_8014A378(void);
extern void* memset(void*, int, unsigned long);

typedef struct Descriptor {
    unsigned char pad[0x90];
    void* callback;
    unsigned int value94;
    void* handler;
    unsigned int value9C;
    unsigned int valueA0;
    unsigned int valueA4;
    unsigned char padA8[0x14];
    unsigned char type;
} Descriptor;
...
void fn_80149FDC(Descriptor* descriptor, Work* work)
{
    descriptor->callback = fn_801936FC;
    descriptor->value94 = 0;
    descriptor->handler = fn_8014A378;
