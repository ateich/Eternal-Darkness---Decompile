...
extern int fn_8011F6A4(void*, void*, int, int, void*, int);
...
void fn_80149C1C(void* object, short* output, void* first, void* second, int index)
{
    ...
    if (object != 0) {
        ...
        if (instance != 0) {
            if (fn_8011F598(instance, first, second, index - 1, &result, 1) == -1) {
                fn_8011F6A4(instance, first, 0xF, index - 1, &result, 1);
            }
