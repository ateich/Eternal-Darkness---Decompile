...
int fn_800F2BFC(u32 arg0, u32 *arg1, u8 arg2, u8 *arg3)
{
    int reply_buffer;
    int first_buffer;
    TRKBuffer *buffer;
    ...
    if (result == 0)
        result = append(buffer, 0xD4);
    if (result == 0)
        result = fn_800EFA84(buffer, arg0);
    if (result == 0)
        result = fn_800EFA84(buffer, *arg1);
    if (result == 0)
        result = append(buffer, arg2);
    if (result == 0) {
        *arg3 = 0;
        ...
        if (result == 0)
            result = fn_800EF86C(reply, arg3);
        if (result == 0)
            result = fn_800EF6EC(reply, arg1);
        else
            *arg1 = -1;
